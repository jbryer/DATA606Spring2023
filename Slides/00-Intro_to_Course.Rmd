...
Syllabus and course materials are here: [https://spring2023.data606.net](https://spring2023.data606.net)

The site is built using the [Blogdown](https://bookdown.org/yihui/blogdown/) R package and hosted on [Github](https://github.com/jbryer/DATA606Spring2023). Each page of the site has a "Improve this page" link at the bottom right, use that to start a pull request on Github.
...
Meetups will be recorded and made available the next day on the [course website](https://spring2023.data606.net/course-overview/meetups/).
...
<a href = "https://github.com/jbryer/DATA606Spring2023/blob/master/Resources/Textbooks/os4.pdf"><img src = 'images/openintro.jpeg' alt = 'Open Intro Statistics' height = '375px' /></a>
...
<a href = "https://github.com/jbryer/DATA606Spring2023/blob/master/Resources/Textbooks/lsr-0.6.pdf"><img src = 'images/lsr.png' alt = 'Learning Statistics with R' height = '375px' /></a>
...
* Participation (10%)
	* [DAACS](https://spring2023.data606.net/assignments/daacs)
	* [One Minute Papers](https://spring2023.data606.net/assignments/participation)
* [Labs](https://spring2023.data606.net/assignments/labs) (35%)
...
* [Data Project](https://spring2023.data606.net/assignments/project) (30%)
...
* [Exams](https://spring2023.data606.net/assignments/exams/)
	* Midterm (10%)
	* Final exam (15%)
...
* Slack Channel: https://DATA606Spring2023.slack.com
	* [Click here to join the group](https://join.slack.com/t/cuny-qt08884/shared_invite/zt-1nkr1zeep-tWuVTWt2esX4wGLoKPYSyQ)
...
* Install [R](https://cran.r-project.org) and [RStudio](https://rstudio.com) on your own computer. I encourage everyone to do this at some point by the end of the semester. I have instructions on the course website here: https://spring2023.data606.net/course-overview/software/
...
* [Join the Slack channel](https://join.slack.com/t/DATA606Spring2023/shared_invite/zt-1ddw97uao-7M9JWWBPHjf0B_WdqJ8B8Q)
...
[`r icons::fontawesome("slack")` DATA606Spring2023.slack.com](https://DATA606Spring2023.slack.com)  
...
[`r icons::fontawesome("link")` spring2023.data606.net](https://spring2023.data606.net)   
